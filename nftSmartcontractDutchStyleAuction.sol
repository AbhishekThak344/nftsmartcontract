...
contract DutchStyleNFT is Ownable, ERC721A {
    ...
    address public constant FOUNDER_ADD = 0x123;
    address public constant DEV_FUND = 0x456;
    ...
    constructor() ERC721A("DUTCH STYLE NFT", "DSN") {} 
